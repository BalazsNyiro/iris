...
func IsNumber(txt string) bool { // basic fun
...
func IntMin(a, b int) int { // basic fun
	if a < b {
		return a
	}
	return b
...
func IntMax(a, b int) int { // basic fun
	if a > b {
		return a
	}
	return b
...
// wrapper, not tested
func Int2Str(i int) string { // basic fun
	return strconv.Itoa(i)
}

// wrapper, not tested
func Str2Int(txt string) int { // basic fun
...
// TESTED
func StrMath(a, operator, b string) string { // basic fun
	a_int := Str2Int(a)
	b_int := Str2Int(b)
	if operator == "-" {
...
// TESTED
func StrDoubleSpacesRemove(txt string) string { // basic fun
...
// TESTED
func StrListRemoveEmptyElems(list []string, useTrim bool) []string { // basic fun
	cleaned := []string{}
...
// TESTED
func ExprOperatorIsValid(operatorChecked string) bool { // basic fun
...
func DebugInfoSave(windows Windows) { // basic fun
...
func WindowsGetWinNamesPublicsSorted(windows Windows) []string { // basic fun
	winNames := []string{}
...
func WindowsKeepPublicOnly(windows Windows) Windows { // basic fun
...
func WinNamesKeepPublicOnly(winNames []string, sort_the_names bool) []string { // basic fun
	publicNames := []string{}
...
func WinNameIsPublic(winName string) bool { // basic fun
	public := true
...
// Tested
func WinNamesSortByAttribute(windows Windows, winNames []string, attribName, sortingMode string) []string { // basic fun
